    ...
    <main class="form-signin">
        ...
        <form method="POST" action="/register/post">
            ...
            <div class="form-floating" id="floatingDiv">
                <input style="border-radius: unset;
                border-bottom: none;" name="name" value="{{ old('name') }}" type="text" class="form-control"
                    id="floatingInput1" placeholder="name@example.com">
                <label for="floatingInput1">Name</label>
            </div>
            <div class="form-floating">
                <input style="border-radius: unset;" name="email" value="{{ old('email') }}" type="email"
